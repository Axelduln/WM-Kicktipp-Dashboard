...
const UPDATED = "Wed 8 Jul 2026, 11:00 UTC";
...
{ md:6, label:"Matchday 6 · Round 2: Groups I–L · 22–24 Jun", games:[
  {h:"🇳🇴 Norway",a:"🇸🇳 Senegal",grp:"I",res:[3,2],you:[2,1],exp:null,note:"Haaland double (and a Pedersen opener) sees Norway past Senegal. Your 2-1 got the winner (+2)."},
  {h:"🇫🇷 France",a:"🇮🇶 Iraq",grp:"I",res:[3,0],you:[4,1],exp:null,note:"Mbappé brace + Dembélé; France through. Your 4-1 got the winner & GD (+3)."},
  {h:"🇦🇷 Argentina",a:"🇦🇹 Austria",grp:"J",res:[2,0],you:[3,1],exp:null,note:"Argentina win to close in on the group. Your 3-1 got the winner (+2)."},
  {h:"🇯🇴 Jordan",a:"🇩🇿 Algeria",grp:"J",res:[1,2],you:[0,1],exp:null,note:"Gouiri's 82nd-minute winner eliminates Jordan. Your 0-1 got the winner & GD (+3)."},
...
{ md:7, label:"Matchday 7 · Final group round: Groups A–D · 24–25 Jun", games:[
  {h:"🇲🇽 Mexico",a:"🇨🇿 Czechia",grp:"A",res:[3,0],you:[1,0],exp:null,model:null,note:"Mexico become first co-host to win all 3 group games; Quiñones hat-trick. Your 1-0 got the winner (+2)."},
  {h:"🇰🇷 South Korea",a:"🇿🇦 South Africa",grp:"A",res:[0,1],you:[1,0],exp:null,model:null,note:"South Africa qualify as Group A runners-up; South Korea eliminated. You tipped SK win (0)."},
  {h:"🇨🇭 Switzerland",a:"🇨🇦 Canada",grp:"B",res:[2,1],you:[1,2],exp:null,model:null,note:"Vargas and Manzambi send Switzerland through as group winners. You tipped Canada (0)."},
  {h:"🇧🇦 Bosnia",a:"🇶🇦 Qatar",grp:"B",res:[3,1],you:[2,1],exp:null,model:null,note:"Alajbegovic youngest WC scorer; Bosnia advance as best 3rd. Your 2-1 got the winner (+2)."},
  {h:"🇧🇷 Brazil",a:"🏴󠁧󠁢󠁳󠁣󠁴󠁿 Scotland",grp:"C",res:[3,0],you:[1,0],exp:null,model:null,note:"Vinícius Júnior brace; Brazil win Group C. Your 1-0 got the winner (+2)."},
  {h:"🇲🇦 Morocco",a:"🇭🇹 Haiti",grp:"C",res:[4,2],you:[1,0],exp:null,model:null,note:"Morocco's goal-fest secures 2nd in Group C. Your 1-0 got the winner (+2)."},
  {h:"🇺🇸 USA",a:"🇹🇷 Türkiye",grp:"D",res:[2,3],you:[2,0],exp:null,model:null,note:"Kaan Ayhan 90+8' completes a stunning Turkey comeback — dead rubber for USA. You tipped USA win (0)."},
  {h:"🇦🇺 Australia",a:"🇵🇾 Paraguay",grp:"D",res:[0,0],you:[1,0],exp:null,model:null,note:"Goalless draw: Australia qualify 2nd, Paraguay as best-3rd. You tipped Australia win (0)."},
]},
{ md:8, label:"Matchday 8 · Final group round: Groups E–H · 25–26 Jun", games:[
  {h:"🇩🇪 Germany",a:"🇪🇨 Ecuador",grp:"E",res:[1,2],you:[1,0],exp:null,model:null,note:"Ecuador shock Germany in a dead rubber — Germany still top on accumulated points. You tipped Germany win (0)."},
  {h:"🇨🇮 Ivory Coast",a:"🇨🇼 Curaçao",grp:"E",res:[2,0],you:[2,0],exp:null,model:null,note:"Ivory Coast qualify as Group E runners-up. Your EXACT 2-0 (+4)!"},
  {h:"🇳🇱 Netherlands",a:"🇹🇳 Tunisia",grp:"F",res:[3,1],you:[2,1],exp:null,model:null,note:"Netherlands win Group F convincingly. Your 2-1 got the winner (+2)."},
  {h:"🇯🇵 Japan",a:"🇸🇪 Sweden",grp:"F",res:[1,1],you:[2,1],exp:null,model:null,note:"Both advance — Japan 2nd, Sweden as best 3rd. You tipped Japan win (0)."},
  {h:"🇧🇪 Belgium",a:"🇳🇿 New Zealand",grp:"G",res:[5,1],you:[2,1],exp:null,model:null,note:"Belgium demolish NZ 5–1 to seal top spot in Group G. Your 2-1 got the winner (+2)."},
  {h:"🇮🇷 Iran",a:"🇪🇬 Egypt",grp:"G",res:[1,1],you:[1,2],exp:null,model:null,note:"Egypt claim 2nd in Group G on goal difference; Iran eliminated. You tipped Egypt win (0)."},
  {h:"🇪🇸 Spain",a:"🇺🇾 Uruguay",grp:"H",res:[1,0],you:[3,1],exp:null,model:null,note:"Spain top Group H; Uruguay's early exit a major disappointment. Your 3-1 got the winner (+2)."},
  {h:"🇸🇦 Saudi Arabia",a:"🇨🇻 Cape Verde",grp:"H",res:[0,0],you:[1,0],exp:null,model:null,note:"Cape Verde's third draw! First WC debutant to reach knockouts since Slovakia 2010. You tipped SA win (0)."},
]},
{ md:9, label:"Matchday 9 · Final group round: Groups I–L · 26–27 Jun", games:[
  ...
  {h:"🇦🇷 Argentina",a:"🇯🇴 Jordan",grp:"J",res:[3,1],you:[3,0],exp:null,model:null,note:"Argentina top Group J with a perfect record; Messi adds another goal. Your 3-0 got the winner & GD (+3)."},
  {h:"🇦🇹 Austria",a:"🇩🇿 Algeria",grp:"J",res:[3,3],you:[1,0],exp:null,model:null,note:"Wild 3–3 draw; Austria finish 2nd, Algeria advance as best 3rd. You tipped Austria win (0)."},
  {h:"🇨🇴 Colombia",a:"🇵🇹 Portugal",grp:"K",res:[0,0],you:[2,1],exp:null,model:null,note:"Cautious draw; Colombia seal Group K top spot, Portugal through as runners-up. You tipped Colombia win (0)."},
  {h:"🇨🇩 DR Congo",a:"🇺🇿 Uzbekistan",grp:"K",res:[3,1],you:[0,1],exp:null,model:null,note:"DR Congo's 3–1 win earns them a spot as best-3rd; Uzbekistan exit. You tipped Uzbekistan win (0)."},
  {h:"🏴󠁧󠁢󠁥󠁮󠁧󠁿 England",a:"🇵🇦 Panama",grp:"L",res:[2,0],you:[3,1],exp:null,model:null,note:"England top Group L; Panama exit scoreless. Your 3-1 got the winner (+2)."},
  {h:"🇭🇷 Croatia",a:"🇬🇭 Ghana",grp:"L",res:[2,1],you:[3,1],exp:null,model:null,note:"Croatia qualify as Group L runners-up; Ghana advance as best 3rd. Your 3-1 got the winner (+2)."},
]},
{ md:10, nav:"R32", label:"Round of 32 · 28 Jun – 3 Jul", games:[
  {h:"🇨🇦 Canada",a:"🇿🇦 South Africa",grp:"R32",res:[1,0],you:[2,1],exp:null,model:null,note:"Eustaquio 90+2' winner — Canada's first-ever WC knockout win. Your 2-1 got the winner (+2)."},
  {h:"🇧🇷 Brazil",a:"🇯🇵 Japan",grp:"R32",res:[2,1],you:[1,2],exp:null,model:null,note:"Brazil came from behind to beat Japan. You tipped Japan (0)."},
  {h:"🇩🇪 Germany",a:"🇵🇾 Paraguay",grp:"R32",res:[1,1],you:[2,1],exp:null,model:null,note:"SHOCK — Paraguay eliminate Germany on penalties (4-3). You tipped Germany win (0)."},
  {h:"🇳🇱 Netherlands",a:"🇲🇦 Morocco",grp:"R32",res:[1,1],you:[1,2],exp:null,model:null,note:"SHOCK — Morocco eliminate Netherlands on penalties (3-2); echoes of Qatar 2022. You tipped Morocco win, correct call (+2)."},
  {h:"🇳🇴 Norway",a:"🇨🇮 Ivory Coast",grp:"R32",res:[2,1],you:[1,0],exp:null,model:null,note:"Haaland on target; Norway's first-ever WC knockout-round win. Your 1-0 got the winner (+2)."},
  {h:"🇫🇷 France",a:"🇸🇪 Sweden",grp:"R32",res:[3,0],you:[3,1],exp:null,model:null,note:"Mbappé brace; France dominant. Your 3-1 got the winner & GD (+3)."},
  {h:"🇲🇽 Mexico",a:"🇪🇨 Ecuador",grp:"R32",res:[2,0],you:[2,1],exp:null,model:null,note:"Mexico's first knockout-round win since 1986. Your 2-1 got the winner (+2)."},
  {h:"🏴󠁧󠁢󠁥󠁮󠁧󠁿 England",a:"🇨🇩 DR Congo",grp:"R32",res:[2,1],you:[3,0],exp:null,model:null,note:"Kane scored twice; England through. Your 3-0 got the winner (+2)."},
  {h:"🇧🇪 Belgium",a:"🇸🇳 Senegal",grp:"R32",res:[3,2],you:[1,2],exp:null,model:null,note:"Belgium edge a thriller 3–2 AET; Tielemans' penalty decisive. You tipped Senegal (0)."},
  {h:"🇺🇸 USA",a:"🇧🇦 Bosnia",grp:"R32",res:[2,0],you:[2,1],exp:null,model:null,note:"Comfortable USMNT win on home soil. Your 2-1 got the winner (+2)."},
  {h:"🇪🇸 Spain",a:"🇦🇹 Austria",grp:"R32",res:[3,0],you:[2,1],exp:null,model:null,note:"Spain dominant throughout. Your 2-1 got the winner (+2)."},
  {h:"🇵🇹 Portugal",a:"🇭🇷 Croatia",grp:"R32",res:[2,1],you:[3,1],exp:null,model:null,note:"Portugal edge past Croatia 2–1. Your 3-1 got the winner (+2)."},
  {h:"🇨🇭 Switzerland",a:"🇩🇿 Algeria",grp:"R32",res:[2,0],you:[1,0],exp:null,model:null,note:"Switzerland advance comfortably. Your 1-0 got the winner (+2)."},
  {h:"🇪🇬 Egypt",a:"🇦🇺 Australia",grp:"R32",res:[1,1],you:[1,0],exp:null,model:null,note:"Egypt edge Australia on penalties (4-2) to reach the R16 for the first time. You tipped Egypt win (0)."},
  {h:"🇦🇷 Argentina",a:"🇨🇻 Cape Verde",grp:"R32",res:[3,2],you:[3,1],exp:null,model:null,note:"Argentina survive a Cape Verde scare. Your 3-1 got the winner & GD (+3)."},
  {h:"🇨🇴 Colombia",a:"🇬🇭 Ghana",grp:"R32",res:[1,0],you:[2,1],exp:null,model:null,note:"Colombia through with a tight 1–0. Your 2-1 got the winner (+2)."},
]},
{ md:11, nav:"R16", label:"Round of 16 · 4–7 Jul", games:[
  {h:"🇨🇦 Canada",a:"🇲🇦 Morocco",grp:"R16",res:[0,3],you:null,exp:null,model:null,note:"Ounahi brace (50', 82') and Rahimi 90+' — Morocco demolish Canada. First co-host eliminated in the R16. You didn't tip this one."},
  {h:"🇵🇾 Paraguay",a:"🇫🇷 France",grp:"R16",res:[0,1],you:[0,4],exp:null,model:null,note:"Mbappé penalty (VAR, 69') the only difference; France advance to the QF. Your 0-4 got the winner (+2)."},
  {h:"🇧🇷 Brazil",a:"🇳🇴 Norway",grp:"R16",res:[1,2],you:[3,1],exp:null,model:null,note:"Haaland brace (79', 90') — Norway reach their first-ever WC QF. You tipped Brazil (0)."},
  {h:"🇲🇽 Mexico",a:"🏴󠁧󠁢󠁥󠁮󠁧󠁿 England",grp:"R16",res:[2,3],you:[2,1],exp:null,model:null,note:"Bellingham quickfire brace, Quansah red (54'), Kane pen (60'); 10-man England hold on at the Azteca. You tipped Mexico win (0)."},
  {h:"🇵🇹 Portugal",a:"🇪🇸 Spain",grp:"R16",res:[0,1],you:[2,3],exp:null,model:null,note:"Merino 90+' winner for Spain; widely reported as Ronaldo's final WC game. Your 2-3 got the winner (+2)."},
  {h:"🇺🇸 USA",a:"🇧🇪 Belgium",grp:"R16",res:[1,4],you:[2,1],exp:null,model:null,note:"Belgium dominant from the 9th minute. You tipped USA win (0)."},
  {h:"🇪🇬 Egypt",a:"🇦🇷 Argentina",grp:"R16",res:[2,3],you:[1,3],exp:null,model:null,note:"Stunning Argentina comeback: 0–2 down in 78', then Romero (79'), Messi (83'), Fernandez (90+'). Your 1-3 got the winner (+2)."},
  {h:"🇨🇭 Switzerland",a:"🇨🇴 Colombia",grp:"R16",res:[0,0],you:[2,1],exp:null,model:null,note:"Goalless after 120 min; Switzerland win 4-3 on pens. You tipped Switzerland win, correct call (+2)."},
]},
